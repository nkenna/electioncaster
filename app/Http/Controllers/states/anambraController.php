...
public function anambraVoteLGA(){
    ...
    //bar chart - party votes in Anambra LGAs
            ...
            ->dataset('LP', [$aguataLp,$anambraEastLp,$anambraWestLp,$enugulp,$anaochaLp,$awkaNorthLp,$awkaSouthLp,$ayamelumLp,$dunukofiaLp,$ekwusigoLp,$idemiliNorthLp,$idemiliSouthLp,$ihialaLp,$njikokaLp,$nnewiNorthLp,$nnewiSouthLp,$ogbaruLp,$onitshaNorthLp,$onitshaSouthLp,$orumbaNorthLp,$orumbaSouthLp,$oyiLp])
